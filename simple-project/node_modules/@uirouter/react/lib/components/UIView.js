...
function useUiCanExitClassComponentHook(router, stateName, maybeComponentClass) {
    ...
    function callbackRef(componentInstance) {
        ...
        if (previous !== componentInstance) {
            ...
            var uiCanExit = (_a = componentInstance) === null || _a === void 0 ? void 0 : _a.uiCanExit;
            if (uiCanExit) {
    ...
    return react_1.useMemo(function () {
        var _a, _b, _c;
        var isComponentClass = ((_b = (_a = maybeComponentClass) === null || _a === void 0 ? void 0 : _a.prototype) === null || _b === void 0 ? void 0 : _b.render) || ((_c = maybeComponentClass) === null || _c === void 0 ? void 0 : _c.render);
...
var View = react_1.forwardRef(function View(props, forwardedRef) {
    ...
    var _d = useViewConfig(), viewConfig = _d.viewConfig, configUpdated = _d.configUpdated;
    var component = react_1.useMemo(function () { var _a, _b; return (_b = (_a = viewConfig) === null || _a === void 0 ? void 0 : _a.viewDecl) === null || _b === void 0 ? void 0 : _b.component; }, [viewConfig]);
    ...
    var viewContext = (_b = (_a = viewConfig) === null || _a === void 0 ? void 0 : _a.viewDecl) === null || _b === void 0 ? void 0 : _b.$context;
    var stateName = (_c = viewContext) === null || _c === void 0 ? void 0 : _c.name;
    ...
    var injector = react_1.useMemo(function () { var _a; return (_a = resolveContext) === null || _a === void 0 ? void 0 : _a.injector(); }, [resolveContext]);
    var transition = react_1.useMemo(function () { var _a; return (_a = injector) === null || _a === void 0 ? void 0 : _a.get(core_1.Transition); }, [injector]);
